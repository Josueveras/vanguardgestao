...
}, (prev, next) => prev.lead === next.lead); // Deep comparison optimization
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fadeIn">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl h-[85vh] flex flex-col overflow-hidden">
                ...
                <div className="p-5 border-t border-gray-200 bg-gray-50 flex justify-end gap-3">
                    ...
                    <button onClick={handleSave} className="px-6 py-2.5 rounded-lg text-sm font-bold text-white bg-vblack hover:bg-gray-800 transition-all flex items-center gap-2 shadow-lg"><Check size={18} weight="bold" /> Salvar</button>
                </div>
            </div>
        </div>
    );
...
export const CRMModule: React.FC = () => {
  const { leads, addLead, updateLead } = useVanguard();
